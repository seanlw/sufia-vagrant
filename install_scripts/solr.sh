...
cp -v /tmp/solr-"$SOLR_VERSION"/dist/solr-analysis-extras-4.10.3.jar $SOLR_HOME/lib
cp -Rv /tmp/solr-"$SOLR_VERSION"/contrib/analysis-extras $SOLR_HOME/lib/contrib
cp -Rv /tmp/solr-"$SOLR_VERSION"/contrib/extraction $SOLR_HOME/lib/contrib
